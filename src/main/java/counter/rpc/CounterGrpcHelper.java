...
public class CounterGrpcHelper {
    ...
    public static void initGRpc() {
        if ("com.alipay.sofa.jraft.rpc.impl.GrpcRaftRpcFactory".equals(RpcFactoryHelper.rpcFactory().getClass()
            .getName())) {
            RpcFactoryHelper.rpcFactory().registerProtobufSerializer(GetRequest.class.getName(), GetRequest.getDefaultInstance());
            RpcFactoryHelper.rpcFactory().registerProtobufSerializer(UpdateRequest.class.getName(), UpdateRequest.getDefaultInstance());
            RpcFactoryHelper.rpcFactory().registerProtobufSerializer(ValueResponse.class.getName(), ValueResponse.getDefaultInstance());
            ...
            try {
                ...
                registerRespInstance.invoke(null, GetRequest.class.getName(), ValueResponse.getDefaultInstance());
                registerRespInstance.invoke(null, UpdateRequest.class.getName(), ValueResponse.getDefaultInstance());
            } catch (Exception e) {
