...
import counter.storage.CounterSnapshotFile;
...
import static counter.CounterOperation.GET;
import static counter.CounterOperation.UPDATE;
...
public class StateMachine extends StateMachineAdapter {
            ...
            if (counterOperation != null) {
                switch (counterOperation.getOp()) {
                    case GET:
                        ...
                        break;
                    case UPDATE:
                        final int delta = counterOperation.getChange();
    ...
    @Override
    public void onSnapshotSave(final SnapshotWriter writer, final com.alipay.sofa.jraft.Closure done) {
