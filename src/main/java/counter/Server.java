...
import counter.rpc.GetRequestProcessor;
import counter.rpc.UpdateRequestProcessor;
...
public class Server {
    ...
    public Server(final String dataPath, final String groupId, final PeerId serverId, final NodeOptions nodeOptions) throws IOException {
        ...
        rpcServer.registerProcessor(new GetRequestProcessor(service));
        rpcServer.registerProcessor(new UpdateRequestProcessor(service));
        // init state machine
    ...
    public static void main(final String[] args) throws IOException {
        ...
        System.out.println("Started counter server at port:"
                           + server.getNode().getNodeId().getPeerId().getPort());
